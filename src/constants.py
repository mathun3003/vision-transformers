...
TARGET_IMAGE_SIZE: Final[int] = int(MODEL_NAME.rsplit('-', maxsplit=1)[-1])
...
VIT_GIF_URL: Final[URL] = URL('https://research.google/blog/transformers-for-image-recognition-at-scale/')
